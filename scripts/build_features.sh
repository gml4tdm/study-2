...
./target/release/pipeline generate-train-test-triples -i ../data/graphs/apache-derby/*.odem -o ../data/triples/apache-derby -m "db-derby=apache-derby"
./target/release/pipeline generate-train-test-triples -i ../data/graphs/hibernate/*.odem -o ../data/triples/hibernate -m "hibernate-core=hibernate"
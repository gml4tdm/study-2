...
pub struct FileChangeInfo {
    ...
    package_old: Option<String>,
    package_new: Option<String>,
    action: String,
...
pub struct ClassChangeInfo {
    ...
    pub package_old: Option<String>,
    pub package_new: Option<String>,
    pub action: String,
...
impl From<FileChangeInfo> for ClassChangeInfo {
    fn from(info: FileChangeInfo) -> Self {
        Self {
            ...
            package_old: info.package_old,
            package_new: info.package_new,
            action: info.action,
